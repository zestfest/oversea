...
class TestOSDPartitions():
    ...
    def test_create(self, ex_mock, pp_mock, lp_mock):
        ...
        test_module.__salt__['helper.run'].assert_any_call('sgdisk -n 2:0:+1000 -t 2:5CE17FCE-4087-4169-B7FF-056CC58473F9 /dev/nvme0n1')
    ...
    def test_create_1(self, ex_mock, pp_mock, lp_mock):
        ...
        lp_mock.assert_called_with(osd_config.device)
        pp_mock.assert_called_with(osd_config.device)
        test_module.__salt__['helper.run'].assert_called_with('sgdisk -n 2:0:+1000 -t 2:5CE17FCE-4087-4169-B7FF-056CC58473F9 /dev/nvme0n1')
    ...
    def test_create_2(self, ex_mock, pp_mock, lp_mock):
        ...
        with pytest.raises(BaseException) as excinfo:
            obj.create(osd_config.device, [('wal', 1000)])
            lp_mock.assert_called_with(osd_config.device)
            assert 'sgdisk -n 2:0:+1000 -t 2:5CE17FCE-4087-4169-B7FF-056CC58473F9 /dev/nvme0n1 failed' in str(excinfo.value)
    ...
    def test_create_3(self, ex_mock, pp_mock, lp_mock):
        ...
        lp_mock.assert_called_with(osd_config.device)
        pp_mock.assert_called_with(osd_config.device)
        test_module.__salt__['helper.run'].assert_called_with('sgdisk -N 2 -t 2:5CE17FCE-4087-4169-B7FF-056CC58473F9 /dev/sdx')
    ...
    def test_create_4_last_part(self, ex_mock, pp_mock, lp_mock):
        ...
        lp_mock.assert_called_with(osd_config.device)
        test_module.__salt__['helper.run'].assert_any_call('sgdisk -n 5:0:+1000 -t 5:5CE17FCE-4087-4169-B7FF-056CC58473F9 /dev/sdx')
